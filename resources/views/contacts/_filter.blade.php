        ...
        <form >
            ...
            <div class="row">
                <div class="col">
                    ...
                    <!-- Check if file exist then include file -->
                    @includeIf('contacts._4company-selection')
                    <!-- Checf if array contain value then include file -->
                    @includeWhen(!empty($companiese), 'contacts._company-selection')
                    <!-- Oppsite of above condition -->
