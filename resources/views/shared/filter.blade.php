        ...
        <form >
            ...
            <div class="row">
                <div class="col">
                    ...
                    @endisset
                    <!-- Check if file exist then include file **includeIf -->
                    <!-- Checf if array contain value then include file **includeWhen -->
                    <!-- Oppsite of above condition **includeUnless -->
                    {{-- @includeUnless(empty($companiess), 'contacts._company-selection') --}}
                </div>
                <div class="col">
...
@push('scripts')
    <script>
        document.getElementById('reset-filter-btn').addEventListener('click', () => {
           ...
           window.location.href = window.location.href.split('?')[0] // refresh page without querystring
        })
